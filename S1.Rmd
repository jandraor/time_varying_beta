...
A critical requirement for robust parameter inference on State-Space Models is 
the precision of likelihood estimates. Namely, that from different runs from a
single set of parameters, we obtain similar likelihood estimates. In the light 
...
decreases as the number of particle increases (convergence), as evidenced below.
This result allow us to continue with the inference process.
...
obtain the uncertainty bounds. Here, we only present the results.
