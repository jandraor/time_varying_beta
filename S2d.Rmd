...
weekly incidence counts are distributed according to the Poisson distribution,
and that mobility data is a proxy measurement for the relative effective contact
rate. We refer to this model in S1 as **Candidate 6**. In particular, we apply 
_Iterated Filtering_ and the _Particle Filter_ to obtain from Candidate 6 
...
plot_wkl_fit(pred_df, actual_inc_df, y_lab = "C[t]", "Incidence", shape = 18, 
             GBM_colour) -> g1
...
plot_wkl_fit(pred_df, actual_df, y_lab = "Z[t]", "Relative transmission rate", 
