...
fn     <- "./Saved_objects/Irish_data/SEI3R_GBM/Global_search2.rds"
seed   <- 1270401374
...
fn          <- "./Saved_objects/Irish_data/SEI3R_GBM/Global_search2_ll.rds"
ll_obj      <- mif_ll(mif_results, Np = 100000, 1270401374, n_cores = 7, fn)
