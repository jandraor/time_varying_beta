...
ptb    <- rw_sd(P_0 = ivp(0.02), zeta = 0.02, alpha = 0.02)
...
```{r}
zeta_ptb <- rw_sd(P_0 = ivp(0.02), alpha = 0.02)
...
```{r}
source("./R_scripts/likelihood_funs.R")
P_0_ptb <- rw_sd(zeta = 0.02, alpha = 0.02)
...
```{r}
alpha_ptb <- rw_sd(zeta = 0.02, P_0 = ivp(0.02))
